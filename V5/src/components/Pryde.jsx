  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.articlewrapper}>
        ...
        <img src={handshake} />
        <div className={styles.caption}><p>The login screen for PRYDE Connect.</p></div>
        <h1> The Problem </h1>
        ...
        <img src={color} />
        <div className={styles.caption}><p>The website color scheme.</p></div>
        ...
        <img src={dich} />
        <div className={styles.caption}><p>Two examples of how the color/role pairing was presented: User cards in a study page, and user profiles.</p></div>
