  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.title}>
        ...
        <h2 className={styles.titlecaption}> Connecting youth development researchers across New York State. </h2>
      </div>
      <div className={articlecss.articlewrapper}>
        ...
        <img className={articlecss.articleimage} src={handshake} />
        ...
        <img className={articlecss.articleimage} src={sketch} />
        <div className={articlecss.caption}><p>The login screen for PRYDE Connect.</p></div>
        <h1> The Solution </h1>
        ...
        <div className={"gallery"}>
          <iframe width="560" height="315" src="https://www.youtube.com/embed/zJJ5xIufB5Y" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          <iframe width="560" height="315" src="https://www.youtube.com/embed/xshAHyfOYSQ" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <h1> Visual Design </h1>
        <h2> Colors </h2>
        ...
        <img className={articlecss.articleimage} src={color} />
        ...
        <img className={articlecss.articleimage} src={dich} />
        ...
        <img className={articlecss.articleimage} src={icons} />
        ...
        <img className={articlecss.articleimage} src={duo} />
        ...
        <img className={articlecss.smallimage} src={interest} />
