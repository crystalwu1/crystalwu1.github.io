  ...
  return (
    <div>
      <div className={styles.wrapper} style={{ backgroundImage: "url(" + name + ")" }}>
        ...
        <a href={'mailto:crystalwu12340@gmail.com'} target='_blank' rel="noopener noreferrer"> <img src={mail} alt="email" /> </a>
        <a href={'https://www.linkedin.com/in/crystal-wu-/'} target='_blank' rel="noopener noreferrer" > <img src={link} alt="linkedin" /> </a>
        <a href={'https://drive.google.com/file/d/1tQ1Z_DPWQfzoKFAUCmRRI-L5L9ZhDUnJ/view?usp=sharing'} rel="noopener noreferrer" target='_blank'> <img src={resume} alt="resume" /> </a>
