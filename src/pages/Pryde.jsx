      ...
      <div className={styles.logo}>
        ...
        <div>
          ...
          <div className={styles.halftextbox}>
            <h2> Connecting youth development researchers across New York State.
              {/* <a href="http://cusail.engineering.cornell.edu" target="_blank">website >></a> */}
            </h2>
          </div>
          <div className={personalstyles.paragraphs}>
            ...
            <img src={handshake} />
            <div className={personalstyles.caption}><p>The login screen for PRYDE Connect.</p></div>
            <h1> The Problem </h1>
            ...
            <img src={color} />
            <div className={personalstyles.caption}><p>The website color scheme.</p></div>
            ...
            <img src={dich} />
            <div className={personalstyles.caption}><p>Two examples of how the color/role pairing was presented: User cards in a study page, and user profiles.</p></div>
